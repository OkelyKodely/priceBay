  ...
  <div class="signup" style="float:left;position:relative;top:-0px">
    <div style="height:80px">
      ...
      <p style="font-size:11px">You are given the option to subscribe to our marketing material.  <br>By clicking on Subscribe you agree to receive information from us <br>regarding our products and services from time to time.</p>
      <br><br>
